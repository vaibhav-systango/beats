export const AuthMessages = {
  ...
  TOO_MANY_ATTEMPTS: 'Maximum OTP request attempts reached. Please try again later.',
  UNEXPECTED_ERROR: 'An unexpected error occurred. Please try again later.',
};

export const AuthConstants = {
  OTP_EXPIRY_DURATION_MS: Number(process.env.OTP_EXPIRY_DURATION_MS) || 60 * 60 * 1000,
  OTP_THROTTLE_DURATION_MS: Number(process.env.OTP_THROTTLE_DURATION_MS) || 30 * 1000,
